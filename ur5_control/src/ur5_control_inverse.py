...
class CompareTrajectory():
    ...
    def timer_callback(self,event): 
        ...
        tetha_1 = atan2(P_5[1],P_5[0])+acos(d3/sqrt(P_5[0]**2+P_5[1]**2))+pi/2
        ...
        if abs(self.J[0,0]-tetha_1)>=abs(self.J[0,0]-tetha_1x):
            tetha_1 = tetha_1x

        rex = (-self.position[0]*sin(tetha_1)+self.position[1]*cos(tetha_1)-d3)/d5
        tetha_5 = acos(rex)

        if abs(tetha_5 - self.J[4,0]) >= abs(-tetha_5 -self.J[4,0]):
            tetha_5 *= -1

        print("tetha 1R: ",self.J[0,0])
        print("tetha 1E: ",tetha_1)

        print()
        print("tetha 5R: ",self.J[4,0])
        print("tetha 5E: ",tetha_5)
        print()



        print("tetha 6R: ",self.J[5,0])
        ...
        tetha_6 = atan2((-T_i[1,0]*sin(tetha_1)+T_i[1,1]*cos(tetha_1))/sin(tetha_5),(T_i[0,0]*sin(tetha_1)-T_i[0,1]*cos(tetha_1))/sin(tetha_5))
        print("tetha 6E: ",tetha_6)

        T*

        print()
        print("tetha 3R: ",self.J[2,0])
        print("tetha 3E: ",tetha_3)
        ...
        self.poses[0] = new_position
        self.orien[0] = new_orientation
    ...
    def get_link_callback(self,msg):
        ...
        self.position_link = [position.x,position.y,position.z]

        orientation = msg.pose[-2].orientation
        orientation = [orientation.x,orientation.y,orientation.z,orientation.w]
        self.orientation_link = list(euler_from_quaternion(orientation))
